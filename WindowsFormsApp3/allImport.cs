...
{
    public partial class allImport : Form
    {
        ...
        private void allImport_Load(object sender, EventArgs e)
        {   
            sqliteConnection.Open();

            sqliteCommand = new SQLiteCommand("select * from importfiledetails", sqliteConnection);
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox1.Text == "File No")
            {
                ...
                sqliteCommand = new SQLiteCommand("select fileno from importfiledetails", sqliteConnection);
                sqliteDataReader = sqliteCommand.ExecuteReader();
            ...
            else if (comboBox1.Text == "Invoice No")
            {
                ...
                sqliteCommand = new SQLiteCommand("select file_invoice_no from importfiledetails", sqliteConnection);
                sqliteDataReader = sqliteCommand.ExecuteReader();
            ...
            else if(comboBox1.Text == "Customer Ref No")
            {
                ...
                sqliteCommand = new SQLiteCommand("select invoiceno from importfiledetails", sqliteConnection);
                sqliteDataReader = sqliteCommand.ExecuteReader();
            ...
            else if(comboBox1.Text == "Client Name")
            {
                ...
                sqliteCommand = new SQLiteCommand("select name from importfiledetails", sqliteConnection);
                sqliteDataReader = sqliteCommand.ExecuteReader();
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox1.Text == "File No")
            {
                ...
                sqliteCommand = new SQLiteCommand("select * from importfiledetails where fileno = '" + comboBox2.Text + "'", sqliteConnection);
                sqliteDataReader = sqliteCommand.ExecuteReader();
            ...
            else if (comboBox1.Text == "Invoice No")
            {
                ...
                sqliteCommand = new SQLiteCommand("select * from importfiledetails where file_invoice_no = '" + comboBox2.Text + "'", sqliteConnection);
                sqliteDataReader = sqliteCommand.ExecuteReader();
            ...
            else if (comboBox1.Text == "Customer Ref No")
            {
                ...
                sqliteCommand = new SQLiteCommand("select * from importfiledetails where invoiceno = '" + comboBox2.Text + "'", sqliteConnection);
                sqliteDataReader = sqliteCommand.ExecuteReader();
            ...
            else if(comboBox1.Text == "Client Name")
            {
                ...
                sqliteCommand = new SQLiteCommand("select * from importfiledetails where name = '" + comboBox2.Text + "'", sqliteConnection);
                sqliteDataReader = sqliteCommand.ExecuteReader();
        ...
        private void deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.OK)
            {
                ...
                sqliteCommand = new SQLiteCommand("delete from importfiledetails where fileno = '" + listView1.SelectedItems[0].Text + "'", sqliteConnection);
                sqliteCommand.ExecuteNonQuery();

                sqliteCommand = new SQLiteCommand("delete from importfileparticulars where fileno = '" + listView1.SelectedItems[0].Text + "'", sqliteConnection);
                sqliteCommand.ExecuteNonQuery();
